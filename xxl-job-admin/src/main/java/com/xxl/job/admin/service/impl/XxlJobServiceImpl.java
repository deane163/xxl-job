...
public class XxlJobServiceImpl implements XxlJobService {
	...
	public ReturnT<String> add(XxlJobInfo jobInfo) {
        ...
        try {
            ...
            return new ReturnT<String>(new JobInfoModel(Integer.parseInt(qz_name), Integer.parseInt(qz_group),jobInfo.getJobDesc()).toString());
	...
	public ReturnT<String> reschedule(XxlJobInfo jobInfo) {
        ...
        try {
            ...
            return ret ? new ReturnT<String>(new JobInfoModel(Integer.parseInt(qz_name), Integer.parseInt(qz_group),jobInfo.getJobDesc()).toString()) : ReturnT.FAIL;
        } catch (SchedulerException e) {
            logger.error(e.getMessage(), e);
        }
